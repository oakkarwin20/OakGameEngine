...
//----------------------------------------------------------------------------------------------------------------------
Quaternion Interpolate( Quaternion start, Quaternion end, float fractionTowardEnd )
{
	Quaternion lerpedResult = start + ( (end - start) * fractionTowardEnd );
	lerpedResult.Normalize();
	return lerpedResult;
}
